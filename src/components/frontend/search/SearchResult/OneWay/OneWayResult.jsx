...
const OneWayResult = ({ flight, openFlightDetails, setOpenFlightDetails }) => {
  const isOpen = openFlightDetails === flight.id;
  const detailsRef = useGsapCollapse(isOpen);
  return (
    <>
      <div className="gap- grid grid-cols-12 items-center p-5">
        {/* Airline */}
      ...
      {/* //* EXPAND */}
      <div className="bg-primary-soft flex items-center justify-between px-4 py-2">
